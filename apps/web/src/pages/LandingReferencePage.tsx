...
function LandingReferencePage({ module, view }: LandingReferencePageProps) {
  ...
  return (
    <V4PageShell className={`landing-ref-shell landing-ref-${module}`} showCopilotMini={false}>
      <div className={`landing-ref-layout${copilotPanel.isPanelOpen ? "" : " copilot-collapsed"}`}>
        ...
        {copilotPanel.isPanelOpen && <LandingCopilot module={module} onClose={copilotPanel.closePanel} view={view} />}
        {!copilotPanel.hasSharedController && !copilotPanel.isPanelOpen && <FloatingCopilotOrb onActivate={copilotPanel.openPanel} />}
      </div>
    </V4PageShell>
  );
}
