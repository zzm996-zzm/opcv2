...
`GET /api/v1/growth/models/{id}/risks`

The MVP response is generated by deterministic rules using the selected model's assumptions and result. Each item contains a human-readable current value, threshold, reason, and suggestion; the AI layer does not decide the level.
  ...
  "risks": [
    {
      ...
      "level": "medium",
      "current_value": "14.0%",
      "threshold": "低于 8% 为高风险，低于 15% 需关注",
      "reason": "成交转化率决定线索能否转化为真实收入。",
      "suggestion": "补齐顾问话术、案例证明和 24 小时内跟进节奏。"
    }
  ],
